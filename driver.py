...
def run_granular_action_pipeline(
    ...
    for iter in range(max_iters):
        ...
        for action_name, action_desc in nl_actions.items():
            params, _ = domain_builder.extract_parameters(
                model=model,
            ...
            preconditions, new_predicates, _ = domain_builder.extract_preconditions(
                model=model,
                domain_desc=domain_desc,
            ...
            effects, new_predicates, _ = domain_builder.extract_effects(
                model=model,
                domain_desc=domain_desc,
